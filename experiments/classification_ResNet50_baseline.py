"""
Experiment: ResNet50 Baseline Classification

Standard ResNet50 with single FC layer.
All layers trainable (NO freezing) - following teacher's methodology requirements.

Usage:
    python experiments/classification_ResNet50_baseline.py [--pretrained True/False] [--dataAugmentation none/standard/enhanced]
