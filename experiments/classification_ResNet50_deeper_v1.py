"""
Experiment: ResNet50 Deeper v1 Classification
...
Purpose: Compare with V2/V3 to understand which layer benefits most from additional conv blocks.

Usage:
    python experiments/classification_ResNet50_deeper_v1.py [--pretrained True/False] [--dataAugmentation none/standard/enhanced]
...
from src.models.ResNet50ClassifierModel import ResNet50Classifier, CUSTOMIZED_DEEPER_V1_CONFIG
from src.training.ResNet50_trainer import ClassificationTrainer, TRAINING_CONFIG_DEEPER_V1
...
def main():
    """Run Customized Deeper v1 Experiment."""
    
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='ResNet50 Deeper v1 Classification Experiment')
    ...
    evaluator.generate_experiment_summary(
        ...
        training_config=TRAINING_CONFIG_DEEPER_V1,
