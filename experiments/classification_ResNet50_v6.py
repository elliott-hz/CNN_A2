"""
Experiment: ResNet50 Customized v6 Classification
...
Purpose: Compare with V5/V7 to understand which layer benefits most from additional conv blocks.

Usage:
    python experiments/classification_ResNet50_v6.py [--pretrained True/False] [--dataAugmentation none/standard/enhanced]
...
from src.models.ResNet50ClassifierModel import ResNet50Classifier, CUSTOMIZED_V6_CONFIG
from src.training.classification_trainer import ClassificationTrainer, TRAINING_CONFIG_V6
...
def main():
    """Run Customized v6 Experiment."""
    
    # Parse command line arguments
    parser = argparse.ArgumentParser(description='ResNet50 Customized v6 Classification Experiment')
    ...
    print("=" * 80)
    print("EXPERIMENT: ResNet50 Customized v6")
    print("=" * 80)
    ...
    model_config = CUSTOMIZED_V6_CONFIG.copy()
    ...
    trainer_temp = ClassificationTrainer(model, config=TRAINING_CONFIG_V6)
    trainer_temp.print_model_summary()
    
    # Step 3: Train
    print("\n[3/5] Training...")
    trainer = trainer_temp  # Reuse the trainer we created for model summary
    criterion = torch.nn.CrossEntropyLoss(label_smoothing=TRAINING_CONFIG_V6.label_smoothing)
    ...
    evaluator.generate_experiment_summary(
        ...
        training_config=TRAINING_CONFIG_V6,
