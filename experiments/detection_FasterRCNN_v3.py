...
from src.models.FasterRCNNDetectorModel import FasterRCNNDetector, FASTERRCNN_V3_CONFIG
...
def main():
    ...
    BATCH_SIZE = 2  # Can potentially increase batch size due to smaller model
    ...
    print(f'Image size: {FASTERRCNN_V3_CONFIG["min_size"]}x{FASTERRCNN_V3_CONFIG["max_size"]}')
    print(f'Customization type: {FASTERRCNN_V3_CONFIG["customize_type"]}')
