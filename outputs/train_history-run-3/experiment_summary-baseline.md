...
- Test F1 (macro): 0.9512
- Test Precision (weighted): 0.9533
- Test Recall (weighted): 0.9518

## Overfitting/Underfitting Analysis

**Pattern Detected:** good_fit

Model appears to have a good fit. Training accuracy (0.9989) and validation accuracy (0.9593) are reasonably close.
