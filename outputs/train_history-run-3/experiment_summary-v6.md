...
- Test F1 (macro): 0.9635
- Test Precision (weighted): 0.9652
...
Model appears to have a good fit. Training accuracy (0.9984) and validation accuracy (0.9697) are reasonably close.
