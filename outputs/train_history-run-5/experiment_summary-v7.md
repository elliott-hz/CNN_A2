...
- Test F1 (macro): 0.9709
- Test Precision (weighted): 0.9729
...
Model appears to have a good fit. Training accuracy (0.9993) and validation accuracy (0.9610) are reasonably close.
