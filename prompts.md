...
4. my process of training have done for 5 times:
...
4.5: i've already done the 4th run of all 8 experiments from baseline to v7 (all results(md and csv files) shown in the folder of CNN_A2/outputs/train_history-run-4),(there is a summary markdonw file named: experiments_analysis.md in this folder)
